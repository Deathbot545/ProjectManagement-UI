...
const Calender: React.FC=()=>{
    ...
    <div className="row">
            <div className="col-lg-5 mb-5 mb-lg-0">
                <h5 className="mb-4 text-info aos-init aos-animate" data-aos="fade-up">Schedule and Agenda</h5>
                <div className="nav nav-pills flex-column aos-init aos-animate" id="myTab" role="tablist" data-aos="fade-up">
                    <button className="nav-link px-4 text-start mb-3 active" id="d1-tab" data-bs-toggle="tab" data-bs-target="#day1" type="button" role="tab" aria-controls="day1" aria-selected="true">
                        <span className="d-block fs-5 fw-bold">Day 1</span>
                        <span className="small">Mon, Jan 2, 2023</span>
                    </button>
                    ...
                    <button className="nav-link px-4 text-start" id="d2-tab" data-bs-toggle="tab" data-bs-target="#day2" type="button" role="tab" aria-controls="day2" aria-selected="false" tabIndex={-1}>
                        <span className="d-block fs-5 fw-bold">Day 2</span>
                        <span className="small">Tue, Jan 3, 2023</span>
                    </button>
                </div>
            </div>
                    ...
                    <div className="tab-pane fade active show" id="day1" role="tabpanel" aria-labelledby="d1-tab">
                        <ul className="pt-4 list-unstyled mb-0">
                            <li className="d-flex flex-column flex-md-row py-4">
                                <span className="flex-shrink-0 width-13x me-md-4 d-block mb-3 mb-md-0 small text-muted">9:00
                                    AM - 10:00 AM</span>
